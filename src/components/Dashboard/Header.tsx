        ...
        <div className="flex-1 max-w-xl mx-4">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 dark:text-white"
            />
          </div>
        </div>
              ...
              {isProfileMenuOpen && (
                ...
                >
                  <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                    <p className="font-medium text-gray-800 dark:text-white">Admin</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">admin@eglise.com</p>
                  </div>
                  <div className="p-2">
                    <Link
                      href="/master/dashboard/profile"
                      className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-colors duration-200"
